...
set style line 71 dt 4 lw 1 lc rgbcolor "slateblue"          pt  6 ps 1
set style line 72 dt 4 lw 1 lc rgbcolor "slateblue"          pt  8 ps 1
set style line 73 dt 4 lw 1 lc rgbcolor "slateblue"          pt 10 ps 1
set style line 74 dt 4 lw 1 lc rgbcolor "slateblue"          pt 12 ps 1
set style line 75 dt 4 lw 1 lc rgbcolor "slateblue"          pt 14 ps 1
...
'../wtimes.petsc_ksp.pc_petsc_asm_lu_asmovlp000.toss_4_x86_64_ib.nx00512.np032.dat'         u 2:($4/$3) w lp ls 21 t "PCASM ( 0)(LU)",\
...
'../wtimes.petsc_ksp.pc_ccmlmg_nvcyc001.toss_4_x86_64_ib.nx00512.np032.dat'                 u 2:($4/$3) w lp ls 31 t "PCCCMLMG (1)",\
...
'../wtimes.petsc_ksp.pc_petsc_asm_ilu_asmovlp000_ilu001.toss_4_x86_64_ib.nx00512.np032.dat' u 2:($4/$3) w lp ls 41 t "PCASM ( 0)(ILU 1)", \
'../wtimes.petsc_ksp.pc_petsc_asm_ilu_asmovlp000_ilu002.toss_4_x86_64_ib.nx00512.np032.dat' u 2:($4/$3) w lp ls 42 t "PCASM ( 0)(ILU 2)", \
'../wtimes.petsc_ksp.pc_petsc_asm_ilu_asmovlp000_ilu004.toss_4_x86_64_ib.nx00512.np032.dat' u 2:($4/$3) w lp ls 43 t "PCASM ( 0)(ILU 4)", \
'../wtimes.petsc_ksp.pc_petsc_asm_ilu_asmovlp000_ilu008.toss_4_x86_64_ib.nx00512.np032.dat' u 2:($4/$3) w lp ls 44 t "PCASM ( 0)(ILU 8)", \
'../wtimes.petsc_ksp.pc_petsc_asm_ilu_asmovlp008_ilu001.toss_4_x86_64_ib.nx00512.np032.dat' u 2:($4/$3) w lp ls 51 t "PCASM ( 8)(ILU 1)", \
...
'../wtimes.petsc_ksp.pc_petsc_asm_ilu_asmovlp016_ilu001.toss_4_x86_64_ib.nx00512.np032.dat' u 2:($4/$3) w lp ls 61 t "PCASM (16)(ILU 1)", \
...
'../wtimes.petsc_ksp.pc_petsc_asm_ilu_asmovlp032_ilu001.toss_4_x86_64_ib.nx00512.np032.dat' u 2:($4/$3) w lp ls 81 t "PCASM (32)(ILU 1)", \
